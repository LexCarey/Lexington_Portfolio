...
const ProjectDisplay = () => {
    return (
        <div className='projects'>
            ...
            <ProjectRight name="INVRT" source='INVRT_Demo.mp4' github="https://github.com/LexCarey/invrt" live="http://invrtofficial.com" desc="INVRT is an eCommerce site I created for my friends clothing brand, INVRT.  Working in a collaborative setting where I could communicate with a close friend and recieve real feedback made this one of my favorite projects to date."/>
        </div>
    )
}
